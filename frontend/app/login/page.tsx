...
export default function LoginPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-16">
      <p className="font-display text-3xl tracking-tight">Memory-Augmented Chatbot</p>
      <p className="mt-2 text-sm text-[var(--muted)]">
        Sign in to continue to your hybrid RAG workspace.
      </p>
      ...
      <p className="mt-4 text-sm text-[var(--muted)]">
        No account?{" "}
        <Link className="text-[var(--warm)] underline" href="/register">
          Create one
        </Link>
      </p>
    </main>
